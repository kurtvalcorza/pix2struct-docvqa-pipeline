...
- Tutorial execution: `tutorials/pix2struct_docvqa_colab.ipynb` ran top-to-bottom in a fresh local kernel; recorded in `docs/release-verification.md` as pre-flight, not supported-runtime evidence.
